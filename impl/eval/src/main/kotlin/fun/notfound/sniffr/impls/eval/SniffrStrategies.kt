...
val EvalSniffr.Strategy.Companion.STRICT: EvalSniffr.Strategy get() = Strict
val EvalSniffr.Strategy.Companion.LENIENT: EvalSniffr.Strategy get() = Lenient

private object Strict : EvalSniffr.Strategy {
...
private object Lenient : EvalSniffr.Strategy {
    override fun <K: Path.Segment, E> diff(
        path: Path,
        lhs: Traversable<Pair<K, E>>,
        rhs: Map<K, E>,
